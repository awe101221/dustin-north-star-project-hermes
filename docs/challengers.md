...
| `requiredIrr` | Positive annualized return stored with the packet. The tournament has no IRR admission floor. 10+10 entry is above 12% and does not require the Capital Line. The Capital Line is populated only above 15%. |

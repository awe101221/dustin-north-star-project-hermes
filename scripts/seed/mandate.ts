...
export const MANDATE_SEED = {
  ...
  hurdle_irr: 0.15,
  rules: [
    { id: "hurdle-15", kind: "gate", title: "Greater than 15% expected 5-year IRR Capital Line on every new underwrite", detail: "The Capital Line is populated only when this hurdle clears. It is the alpha line versus QQQ, not the door. A name enters the ranked 10+10 above 12% and is then ranked with the best names. The tournament has no IRR admission floor. Probability-weighted across bear/base/bull; math_must_work=true." },

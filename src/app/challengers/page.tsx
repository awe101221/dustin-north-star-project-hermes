...
export default async function ChallengersPage() {
  ...
  const header = <PageHeader eyebrow="Hermes · comparative underwriting" title="10 + 10 Challenger Board" description="Find replacements for weaker 10 + 10 names, and watch fallen names for a return on price, earnings, or a material announcement. Capital Line stays above 12%. QQQ remains the default." />;

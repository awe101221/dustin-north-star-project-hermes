  ...
  return (
    <div className="space-y-5">
      ...
      <Link href="/ai-regime" className="panel flex min-h-11 flex-wrap items-center justify-between gap-2 p-4 hover:border-cyan/40 focus-visible:outline-2 focus-visible:outline-cyan">
        <span><span className="block text-[14px] font-semibold text-cyan">AI Regime sleeve</span><span className="mt-1 block text-[12px] text-muted">Thematic workspace for AI, Physical AI, Space AI/infrastructure, and hidden beneficiaries. Sleeve membership stays Dustin-gated.</span></span>
        <ArrowUpRight aria-hidden="true" className="size-4 text-cyan" />
      </Link>

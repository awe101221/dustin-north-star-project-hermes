...
export const SYSTEM_COMPONENTS: SystemComponent[] = [
  ...
  { id: "chrome-qa", name: "Chrome + Playwright QA", layer: "tool", status: "live", role: "Desktop/mobile production verification", reality: "Routes, console, interactions, and 390px overflow are checked before release.", technology: "Google Chrome · Playwright" },
